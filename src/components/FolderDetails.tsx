            ...
            <div className="w-[95%] md:w-[80%] mx-auto bg-white shadow-md py-3">
              <h1 className='text-center text-2xl font-bold'>{currentFolder.title}</h1>  
              {
                ...
                <div className="block">
                  ...
                  {!create
                   ...
                   (
                    <div className="flex justify-center gap-4 items-center w-full">
                      <Link to="/" className='text-xs'>Back To Home  <FaArrowAltCircleLeft className='inline-block' /></Link>
                  ...
                  :
                  <form action="" onSubmit={handleCreateNote} className='bg-white shadow-2xl w-[95%] md:w-[80%] min-h-[80%] mx-auto p-4 rounded-md'>
